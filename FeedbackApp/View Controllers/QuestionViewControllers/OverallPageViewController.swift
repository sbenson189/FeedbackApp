//
//  OverallPageViewController.swift
//  FeedbackApp
//
...
class OverallPageViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func validateResponses (responseCount: Int, responses: Dictionary<Int, Int>) -> Bool {
        ...
        DBHelper.overallReviewScore = counter
        return true
    }
