//
//  RoomServicePageViewController.swift
//  FeedbackApp
//
...
class RoomServicePageViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func validateResponses (responseCount: Int, responses: Dictionary<Int, Int>) -> Bool {
        ...
        DBHelper.roomServiceReviewScore = counter
        return true
    }
