//
//  PoolAndSpaPageViewController.swift
//  FeedbackApp
//
...
class PoolAndSpaPageViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func validateResponses (responseCount: Int, responses: Dictionary<Int, Int>) -> Bool {
        ...
        DBHelper.poolAndSpaReviewScore = counter
        return true
    }
